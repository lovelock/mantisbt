...
public static $g_script_login_cookie = null;

# @global array $g_cache_anonymous_user_cookie_string
public static $g_cache_anonymous_user_cookie_string = null;

# @global array $g_cache_cookie_valid
public static $g_cache_cookie_valid = null;

# @global int $g_cache_current_user_id
public static $g_cache_current_user_id = null;
    ...
    function auth_does_password_match($p_user_id, $p_test_password)
    {
        ...
        foreach ($t_login_methods as $t_login_method) {
            ...
            if (auth_process_plain_password($p_test_password, $t_password, $t_login_method) == $t_password) {
                ...
                if (($t_login_method != $t_configured_login_method) || ((CRYPT == $t_configured_login_method) && utf8_substr($t_password,
                            0, 2) == utf8_substr($p_test_password, 0, 2))
                ) {
    ...
    function auth_generate_confirm_hash($p_user_id)
    {
        ...
        $t_confirm_hash_raw = hash('whirlpool',
            'confirm_hash' . config_get_global('crypto_master_salt') . $t_password . $t_last_visit, true);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input id="username" type="text" disabled="disabled"
                                                           class="input-sm" size="32"
                                                           maxlength="<?php echo DB_FIELD_SIZE_USERNAME; ?>"
                                                           value="<?php echo string_attribute($p_username); ?>"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th class="category">
                                                ...
                                                <td>
                                                    <input id="password" type="password" name="password"
                                                           class="input-sm" size="32"
                                                           maxlength="<?php echo auth_get_password_max_size(); ?>"
                                                           class="autofocus"/>
                                                </td>
                                            </tr>
                                        </table>
